(function(){
  ...
  async function enhancePersonProfile(){
    ...
    if(accessValue){const label=accessValue.parentElement?.querySelector('strong');if(label)label.textContent='Access Level:';accessValue.textContent=accessLabel(learner.organisational_access_role||learner.portal_access_role||'operative')}
